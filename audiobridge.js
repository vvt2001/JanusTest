...
var audiosuspended =
  getQueryStringValue("suspended") !== ""
    ? getQueryStringValue("suspended") === "true"
    : false;
            ...
            janus.attach({
                  ...
                  if (event === "joined") {
                    ...
                    if (msg["participants"]) {
                      ...
                      for (let f in list) {
                        ...
                        else $("#rp" + id + " > i.abmuted").addClass("hide");
                        if (setup === true || setup === "true")
                          $("#rp" + id + " > i.absetup").addClass("hide");
                        else $("#rp" + id + " > i.absetup").removeClass("hide");
                        if (suspended === true)
                          $("#rp" + id + " > i.absusp").removeClass("hide");
                        else $("#rp" + id + " > i.absusp").addClass("hide");
                        if (spatial !== null && spatial !== undefined)
              ...
              onremotetrack: function (track, mid, on, metadata) {
                ...
                if ($("#roomaudio").length === 0) {
                  $("#mixedaudio").append(
                    '<audio class="rounded centered w-100" id="roomaudio" controls autoplay/>'
                  );
